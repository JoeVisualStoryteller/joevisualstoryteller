import { skillCategories, education, summary, personalInfo, keyAchievements, experiences, certifications } from '../data/resumeData2';
import { usePDFExportResume2 } from '../hooks/ResumePage/usePDFExportResume2';

const Resume2: React.FC = () => {
  const { exportToPDF, isGenerating } = usePDFExportResume2();
  const contactLinks = [personalInfo.linkedin?.display, personalInfo.github?.display]
    .filter(Boolean)
    .join(" | ");
